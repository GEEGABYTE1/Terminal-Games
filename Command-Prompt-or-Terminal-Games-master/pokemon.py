...
def introduction():
    ...
    if player1 == 1 and player2 == 1:               # If player 1 chooses Charmander
    ...
    if player1 == 2 and player2 == 1:               #If player 1 chooses Squirtle
    ...
    if player1 == 3 and player2 == 1:               #If player 1 chooses Bulbasaur
