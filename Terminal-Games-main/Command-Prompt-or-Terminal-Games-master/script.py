                    ...
                    for i in range(int(len(self.game_board) - 1), -1 , -1):
                        if i == -1:
                            ...
                            if not self.lane_empty_checker1(self.counter, 0) == True:
                                ...
                                if i == 4:
                                    self.lane2[0] = str(self.player_num) + " "
                                    break
                                elif i == 3:
                                    self.lane3[0] = str(self.player_num) + " "
                                    break
                                elif i == 2:
                                    self.lane4[0] = str(self.player_num) + " "
                                    break
                                elif i == 1:
                                    self.lane5[0] = str(self.player_num) + " "
                                    break
                                elif i == 0:
                                    self.lane6[0] = str(self.player_num) + " "
                                    break
                ...
                if not self.lane_empty_checker1(5, 1) == True:
                    for i in range(int(len(self.game_board) - 1), -1 , -1):
                        if not self.lane_empty_checker1(self.counter, 1) == True:
                            ...
                            if i == 4:
                                self.lane2[1] = str(self.player_num) + " "
                                break 
                            elif i == 3:
                                self.lane3[1] = str(self.player_num) + " "
                                break
                            elif i == 2:
                                self.lane4[1] = str(self.player_num) + " "
                                break 
                            elif i == 1:
                                self.lane5[1] = str(self.player_num) + " "
                                break 
                            elif i == 0:
                                self.lane6[1] = str(self.player_num) + " "
                ...
                if not self.lane_empty_checker1(5, 2) == True:
                    for i in range(int(len(self.game_board) - 1), -1 , -1):
                        if not self.lane_empty_checker1(self.counter, 2) == True:
                            ...
                            if i == 4:
                                self.lane2[2] = str(self.player_num) + " "
                                break 
                            elif i == 3:
                                self.lane3[2] = str(self.player_num) + " "
                                break
                            elif i == 2:
                                self.lane4[2] = str(self.player_num) + " "
                                break 
                            elif i == 1:
                                self.lane5[2] = str(self.player_num) + " "
                                break 
                            elif i == 0:
                                self.lane6[2] = str(self.player_num) + " "
                ...
                if not self.lane_empty_checker1(5, 3) == True:
                    for i in range(int(len(self.game_board) - 1), -1 , -1):
                        if not self.lane_empty_checker1(self.counter, 3) == True:
                            ...
                            if i == 4:
                                self.lane2[3] = str(self.player_num) + " "
                                break 
                            elif i == 3:
                                self.lane3[3] = str(self.player_num) + " "
                                break
                            elif i == 2:
                                self.lane4[3] = str(self.player_num) + " "
                                break 
                            elif i == 1:
                                self.lane5[3] = str(self.player_num) + " "
                                break 
                            elif i == 0:
                                self.lane6[3] = str(self.player_num) + " "
                ...
                if not self.lane_empty_checker1(5, 4) == True:
                    for i in range(int(len(self.game_board) - 1), -1, -1):
                        if not self.lane_empty_checker1(self.counter, 4) == True:
                            ...
                            if i == 4:
                                self.lane2[4] = str(self.player_num) + " "
                                break 
                            elif i == 3:
                                self.lane3[4] = str(self.player_num) + " "
                                break
                            elif i == 2:
                                self.lane4[4] = str(self.player_num) + " "
                                break 
                            elif i == 1:
                                self.lane5[4] = str(self.player_num) + " "
                                break 
                            elif i == 0:
                                self.lane6[4] = str(self.player_num) + " "
                ...
                if not self.lane_empty_checker1(5, 5) == True:
                    for i in range(int(len(self.game_board) - 1), -1 , -1):
                        if not self.lane_empty_checker1(self.counter, 5) == True:
                            ...
                            if i == 4:
                                self.lane2[5] = str(self.player_num) + " "
                                break 
                            elif i == 3:
                                self.lane3[5] = str(self.player_num) + " "
                                break
                            elif i == 2:
                                self.lane4[5] = str(self.player_num) + " "
                                break 
                            elif i == 1:
                                self.lane5[5] = str(self.player_num) + " "
                                break 
                            elif i == 0:
                                self.lane6[5] = str(self.player_num) + " "
                ...
                if not self.lane_empty_checker1(5, 6) == True:
                    for i in range(int(len(self.game_board) - 1), -1, -1):
                        if not self.lane_empty_checker1(self.counter, 6) == True:
                            ...
                            if i == 4:
                                self.lane2[6] = str(self.player_num) + " "
                                break 
                            elif i == 3:
                                self.lane3[6] = str(self.player_num) + " "
                                break
                            elif i == 2:
                                self.lane4[6] = str(self.player_num) + " "
                                break 
                            elif i == 1:
                                self.lane5[6] = str(self.player_num) + " "
                                break 
                            elif i == 0:
                                self.lane6[6] = str(self.player_num) + " "
